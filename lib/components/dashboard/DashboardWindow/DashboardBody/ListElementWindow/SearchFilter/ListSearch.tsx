...
import { Folder, Note } from '@/lib/Interface/dashboard/DashboardWindow/DashboardBody/ListElementWindow/types';
import { SearchIcon } from '../../../../svg'; // Ensure the path is correct
