  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2.5">
      <div className="w-96 p-2 bg-white/10 rounded-lg flex justify-center items-center gap-4 relative">
        ...
        />
        <button
          className={`w-full p-2 flex focus:outline-none justify-center items-center text-base gap-4 ${activeTab === 'Note' ? 'text-white' : 'text-[#dedede]'}`}
          onClick={() => handleTabChange('Note')}
        >
          Note
        </button>
        <button
          className={`w-full p-2 flex focus:outline-none justify-center items-center text-base gap-4 ${activeTab === 'Folder' ? 'text-white' : 'text-[#dedede]'}`}
