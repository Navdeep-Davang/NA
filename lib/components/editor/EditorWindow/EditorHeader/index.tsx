...
const EditorHeader = () => {
    ...
    return ( 
        <div className=" inline-flex sticky top-0 z-50 w-full justify-center">
             <motion.header
                className="p-2 m-4 rounded-lg theme-header-glassblur border theme-header-background theme-header-border shadow-md"
                initial={{ width: "auto" }}
                animate={{
